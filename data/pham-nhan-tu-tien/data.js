  ...
  chars: [
    {
      ...
      tabs: {
        ...
        kinhLich: [
          { bridge: true, khoang: "c0001–c0003", text: "Tam thúc tiến cử Hàn Lập 10 tuổi dự kỳ khảo thí Thất Huyền môn; đi xe ngựa năm ngày cùng hơn ba chục hài đồng tới Thái Hà sơn." },
          { chuong: 4, importance: "normal", tieuDe: "Ký danh đệ tử Thất Huyền môn", text: "Trải qua trắc thí Luyện Cốt Nhai ba chặng; kiệt sức không lên được đỉnh đúng giờ, được sư huynh Trương Quân ôm lên — vào phút cuối thành ký danh đệ tử. Mặc đại phu chọn làm đồng tử chế thuốc tại Thần Thủ Cốc." },
          { chuong: 6, importance: "major", tieuDe: "Thành thân truyền đệ tử Mặc đại phu", text: "Mặc đại phu chính thức nhận Hàn Lập làm thân truyền đệ tử sau khi phát hiện thể chất kỳ dị tại khảo hạch (Ch.8); truyền Vô danh khẩu quyết với điều kiện tra khảo sau nửa năm. Được cấp thạch thất riêng và dược vật trân quý — đặc quyền vô tiền khoáng hậu trong Thất Huyền môn. Đây là điểm khởi đầu của mọi ràng buộc-lợi dụng về sau." },
          { bridge: true, khoang: "c0007–c0009", text: "Khổ tu Vô danh khẩu quyết nửa năm; phát hiện thể nội sinh lương khí lạnh khác hẳn đồng môn; đột phá tầng 2 nhờ dược vật, bị nội thương nhẹ." },
          { chuong: 10, importance: "major", tieuDe: "Nhặt bình thần bí", text: "Nhặt được cái bình kim loại màu xanh biếc nặng bất thường trên đường mòn trong núi. Thử đập bằng thiết chùy tới mười hai phần công lực — bình vẫn không một vết xước. Giấu vào túi da đeo cổ, không khai cho ai. Bình này trở thành bảo vật trục toàn bộ hành trình tu luyện của Hàn Lập." },
          { chuong: 15, importance: "normal", tieuDe: "Đình trệ tầng 3, đề phòng sư phụ", text: "Luyện tới tầng 3 Vô danh khẩu quyết thì đình trệ hơn một năm. Phát giác ánh mắt tham lam của Mặc đại phu qua những lần kiểm tra — lòng đề phòng bắt đầu tăng dần." },
          { bridge: true, khoang: "c0016–c0019", text: "Ra ngoài quan sát trường đấu giang hồ giữa các đệ tử; dùng thủ thuật moi tin từ Kim Đông Bảo; quan sát Lệ sư huynh thi triển Phong Lôi đao pháp." },
          { chuong: 20, importance: "normal", tieuDe: "Cứu Lệ Phi Vũ, kết mối giao dịch", text: "Cứu tỉnh Lệ Phi Vũ bằng ngân châm bên suối; vạch trần bí mật Lệ sư huynh dùng Trừu Tủy Hoàn nguyên viên nhiều năm — đổi lấy sự tin tưởng và ân nghĩa. Hai người bắt đầu giao dịch dược-đổi-võ bí mật, Hàn Lập có được kênh học võ công bên ngoài sự kiểm soát của Mặc đại phu." },
          { chuong: 22, importance: "minor", text: "Bị tâm ma xâm lấn đêm khuya; dùng bình an phù cha mẹ tặng trừ tâm ma, công lực đạt đỉnh phong tầng ba." },
          { chuong: 26, importance: "major", tieuDe: "Nắm phương pháp bình thôi sanh", text: "Qua hai tháng thử nghiệm, xác nhận hoàn toàn cơ chế bình thần bí: hút quang điểm ban đêm trời quang, khoảng 7 ngày tái sinh một giọt lục dịch; nhỏ một giọt nguyên chất lên gốc cây tăng ~100 năm dược tính. Nuôi tam ô thảo thành ngàn năm thành công. Tiếp đó tự phối chế Hoàng Long Đan, Thanh Linh Tán, Kim Tủy Hoàn, Dưỡng Tinh Đan — hơn mười bình thánh dược. Bình thần bí từ đây là vũ khí bí mật toàn bộ chặng Luyện Khí." },
          { chuong: 28, importance: "normal", tieuDe: "Đột phá tầng tư, giấu thực lực", text: "Ăn Hoàng Long Đan và Kim Tủy Hoàn, đột phá tầng tư Trường Xuân công trong một đêm; ngũ cảm tăng vọt. Giấu đột phá thật khi Mặc đại phu về kiểm tra." },
          { chuong: 31, importance: "major", tieuDe: "Bị ép nuốt Thi Trùng Hoàn", text: "Mặc đại phu vạch trần việc Hàn Lập cố ý giấu tiến độ rồi bức hàng: ép nuốt Thi Trùng Hoàn — trùng noãn tiềm phục một năm, không giải dược thì phá vỡ ăn sạch nội tạng chết trong ba ngày ba đêm thống khổ. Hàn Lập khuất phục nhưng ngay lập tức quyết tâm tìm đường tự thoát, không phó thác mạng vào lòng thương của lão." },
          { bridge: true, khoang: "c0032–c0033", text: "Thử giải Thi Trùng Hoàn bằng Thanh Linh Tán — thất bại. Hơn nửa năm sau: đột phá tầng năm Trường Xuân công nhờ đan dược; bắt đầu giao dịch kiếm phổ với Lệ Phi Vũ." },
          { chuong: 37, importance: "normal", tieuDe: "Chọn Trát Nhãn kiếm pháp", text: "Đọc trọn 74 quyển bí tịch do Lệ Phi Vũ trộm từ Thất Tuyệt đường; chọn Trát Nhãn kiếm pháp vì 'tam bất luyện' khớp hoàn cảnh — không cần chân khí, cần nghị lực và thiên phú. Ghi tạc toàn bộ vào trí nhớ thay vì sao chép để tránh bị Mặc đại phu phát hiện." },
          { bridge: true, khoang: "c0038–c0040", text: "Bí mật rèn kiếm và khổ luyện Trát Nhãn kiếm pháp; tiếp tục theo dõi động thái Mặc đại phu qua Kim Đông Bảo." },
          { chuong: 41, importance: "normal", tieuDe: "Bỏ trốn khỏi sơn cốc", text: "Tố giác gian tế Dã Lang bang cho Lệ Phi Vũ lập công; đặt thợ rèn làm vỏ kiếm cải tiến và chuông sắt bí mật. Đêm đó bỏ trốn khỏi sơn cốc, để lại thư hẹn bốn tháng sau gặp lại." },
          { bridge: true, khoang: "c0042", text: "Trên đường ẩn tu: tìm khe núi hẻo lánh, bắt đầu khổ luyện bộ pháp và nội công không bị kiểm soát." },
          { chuong: 43, importance: "normal", tieuDe: "Ẩn tu bốn tháng — đạt tầng sáu", text: "Ẩn tu khe núi hơn bốn tháng: luyện Nhuyễn cốt công, Liễm tức công, Ngụy nặc thuật và La Yên bộ trong rừng gai. Trường Xuân công đạt tầng sáu — tầng cao nhất Mặc đại phu từng cấp; phục hồi thân thể dị thường vượt xa người thường." },
          { bridge: true, khoang: "c0044", text: "Trở lại đúng hẹn; ép Mặc đại phu giao giải dược Thi Trùng Hoàn trước khi cho kiểm tra — giả lộ đột phá tầng tư, che giấu thực lực tầng sáu." },
          { chuong: 45, importance: "normal", tieuDe: "Mặc đại phu trở mặt — đối đầu lần đầu", text: "Mặc đại phu bắt mạch rồi trở mặt ra lệnh khống chế. Nhờ thực lực tầng sáu vượt dự tính, Hàn Lập thoát ra; lần đầu rút kiếm lộ nanh vuốt, tuyên bố quyết sống mái." },
          { bridge: true, khoang: "c0046–c0049", text: "Ác đấu với Mặc đại phu: dùng bột khói + La Yên bộ ẩn mình tấn công một kiếm thất thủ; giao chiến Ma Ngân Thủ; dùng trá ngữ và chủy thủ giấu trong mũi kiếm — lão né thoát nhờ bản năng, chỉ trầy gáy." },
          { chuong: 50, importance: "normal", tieuDe: "Bôi Triền Hương Ti — bị Thiết Nô bắt", text: "Vờ giảng hòa, tiết lộ đã bôi Triền Hương Ti — độc dược từ từ nhập cốt — lên tiêm trùy trước khi đâm trúng. Tuyên bố tánh mạng Mặc đại phu nằm trong tay mình. Nhưng lão có chỗ dựa: Thiết Nô ra tay bắt giữ, Hàn Lập bị trọng thương và mất hộ tâm kính." },
          { bridge: true, khoang: "c0051–c0055", text: "Bị Thiết Nô khống chế bất động; chứng kiến Mặc đại phu phát động Thất Quỷ Phệ Hồn đại pháp hồi xuân; bị dán Định Thần Phù mất quyền điều khiển cơ thể; bị đặt vào trận đồ đoạt xá giữa nhà đá." },
          { chuong: 57, importance: "major", tieuDe: "Thắng đoạt xá — Mặc đại phu chết", text: "Trong cuộc đoạt xá, nguyên thần Hàn Lập hiện ra dưới dạng quang cầu xanh biếc lớn bất thường — nuốt gọn quang cầu vàng của Mặc đại phu, đánh đuổi nguyên thần Dư Tử Đồng chỉ còn 1/3 chạy trốn vào góc nhà đá. Tỉnh lại: Mặc đại phu đã chết, Định Thần Phù biến thành tro. Dùng mưu moi hết thông tin rồi dùng ống đồng độc dịch + kiếm kết liễu hoàn toàn nguyên thần Dư Tử Đồng. Mối hiểm lớn nhất đời Luyện Khí được giải trừ." },
          { bridge: true, khoang: "c0058–c0061", text: "Sau khi diệt trừ hậu hoạn, Hàn Lập dọn dẹp nhà đá bí mật và lục soát di vật, di thể Mặc đại phu." },
          { chuong: 62, importance: "normal", tieuDe: "Di thư — ràng buộc Noãn Dương Bảo Ngọc", text: "Lục soát thi thể Mặc đại phu, phát hiện di thư: lão đã hạ kỳ độc Thi Trùng Hoàn từ trước (chỉ Noãn Dương Bảo Ngọc giải được), đặt giao dịch ràng buộc — Hàn Lập phải tới an bài thân nhân đổi lấy bảo ngọc. Chấp nhận." },
          { chuong: 63, importance: "normal", tieuDe: "Khống chế Thiết Nô — phát hiện Khúc Hồn", text: "Dùng Dẫn Hồn Chung khống chế cự hán thiết nô làm thuộc hạ; nhìn kỹ mặt mới rúng động nhận ra chính là di thể bạn thân Trương Thiết — hồn phách đã mất, bị cải tạo thành thi nhân. Đặt tên Khúc Hồn." },
          { bridge: true, khoang: "c0064", text: "Sắp xếp hậu sự tại Thần Thủ Cốc; giả bút tích thư Mặc đại phu để che giấu cái chết trong thời gian đầu." },
          { chuong: 65, importance: "normal", tieuDe: "Tiếp quản Thần Thủ Cốc — lộ Trường Xuân công cao tầng", text: "Hơn nửa năm sau, giả bút tích thư Mặc đại phu che giấu cái chết; tiếp quản Thần Thủ Cốc, nổi danh khắp Thất Huyền môn là 'Hàn thần y'. Phát hiện 'Trường sinh kinh' của Mặc đại phu thực ra là bí tịch Trường Xuân công ghi thêm hai tầng tiếp theo." },
          { chuong: 67, importance: "major", tieuDe: "Luyện thành pháp thuật — bán tu tiên giả", text: "Giải mã cổ ngữ ba tháng, luyện năm pháp thuật từ bí tịch Trường Xuân công; chỉ luyện thành Hỏa Đạn Thuật và Thiên Nhãn Thuật. Xác nhận có pháp lực thật — là người duy nhất Thất Huyền môn đạt địa vị 'bán tu tiên giả'. Ba pháp thuật còn lại chờ điều kiện từ giới tu tiên mới luyện được; đây là bước đầu tiên thoát khỏi phạm trù võ học phàm nhân." },
          { bridge: true, khoang: "c0068–c0073", text: "Cứu Lý trưởng lão khỏi hỗn hợp kịch độc Dã Lang bang bằng Thanh Linh Tán + ngân châm; xác nhận với Lệ Phi Vũ biết bí mật Trừu Tủy Hoàn." },
          { chuong: 74, importance: "normal", tieuDe: "Luyện thành Ngự Phong Quyết — bay được", text: "Luyện thành Ngự Phong Quyết sau nhiều thất bại — pháp thuật khinh thân dùng pháp lực, bay được một mình. Hàn Lập 18 tuổi." },
          { chuong: 75, importance: "normal", tieuDe: "Đột phá tầng 8, hoàn thiện thân pháp", text: "Trường Xuân công đột phá tầng 8 nhờ ngày ngày ăn linh dược; dung hợp La Yên bộ + Ngự Phong Quyết tạo thân pháp xuất quỷ nhập thần; cải tiến Hỏa Đạn Thuật giữ hỏa cầu trên tay làm vũ khí cận chiến." },
          { bridge: true, khoang: "c0075b", text: "Đoàn đàm phán Thất Huyền môn bị Dã Lang bang phục kích tại Lạc Sa pha bằng nỏ liên châu quân dụng; phần lớn bị giết — Hàn Lập khởi động kế hoạch phản công." },
          { chuong: 76, importance: "normal", tieuDe: "Lên kế hoạch tiêu diệt Dã Lang bang", text: "Triệu Khúc Hồn và dùng linh thức do thám; lần đầu phối hợp chiến thuật toàn diện — vừa ẩn thân vừa điều binh nhắm thẳng sào huyệt Dã Lang bang." },
          { bridge: true, khoang: "c0077–c0083", text: "Triệu Khúc Hồn tiêu diệt nhóm Dã Lang bang vào bắt 'thần y'; cùng Lệ Phi Vũ cải trang thâm nhập quanh Lạc Nhật Phong quan sát trận địa." },
          { bridge: true, khoang: "c0084–c0087", text: "Lần đầu công khai phô thực lực: thi triển La Yên bộ + Ngự Phong Quyết hạ sát hơn mười đệ tử Đoạn Thủy môn trong nháy mắt. Theo Lệ Phi Vũ lên Lạc Nhật Phong ký tử khế; thi triển thân pháp xuất hiện sau lưng Vương Tuyệt Sở khiến cả môn phái kinh ngạc chấp thuận." },
          { chuong: 90, importance: "normal", tieuDe: "Nhận ra pháp thuật Chu Nho — nảy ý đoạt bảo", text: "Nhận ra khẩu quyết Chu Nho điều khiển luồng sáng giống hệt Khu Vật Thuật của mình — xác nhận pháp thuật này thuộc giới tu tiên. Nảy ý muốn giết người đoạt bảo." },
          { chuong: 91, importance: "normal", tieuDe: "Đoạt kiếm phù — lần đầu dùng pháp thuật chiến đấu", text: "Dùng Khống Vật Thuật đoạt kiếm phù từ tay Chu Nho ngay giữa huyết đấu — lần đầu áp dụng pháp thuật tu tiên thật sự vào thực chiến; Chu Nho sửng sốt bỏ thế thượng phong." },
          { bridge: true, khoang: "c0092", text: "Tiếp tục đấu pháp và lực trận kéo dài; tiêu hao Chu Nho bằng chiến thuật kết hợp độn thân và pháp lực." },
          { chuong: 93, importance: "normal", tieuDe: "Hạ người tu tiên đầu tiên — thu Thăng Tiên Lệnh", text: "Dùng mưu nhử Chu Nho bỏ Kim Quang Tráo rồi kết liễu bằng Hỏa Đạn Thuật; thu ba vật phẩm: kiếm phù lục, Thăng Tiên Lệnh bài, gia phả Tần thị. Đây là lần đầu Hàn Lập hạ được người tu tiên thật sự." },
          { chuong: 94, importance: "normal", tieuDe: "Xóa sổ Dã Lang bang tại Lạc Nhật Phong", text: "Dùng ẩn thân và độn thuật xóa sổ hơn 50 người Dã Lang bang còn lại trong tử đấu trường tại Lạc Nhật Phong — Dã Lang bang bị diệt." },
          { bridge: true, khoang: "c0095–c0096", text: "Khổ luyện Khống Vật Thuật với kiếm phù ba ngày; tổng kết ba hạn chế của kiếm phù — tiêu hao lớn, hiệu quả trong 20 trượng, tuổi thọ hữu hạn. Dùng Thiên Nhãn Thuật uy hiếp tâm lý Vương Tuyệt Sở." },
          { bridge: true, khoang: "c0097–c0098", text: "Để lại thuốc kéo dài tuổi thọ cho Lệ Phi Vũ và đan dược cho Vương Tuyệt Sở; ghi thư từ biệt. Cùng Khúc Hồn ngồi xe ngựa rời Thất Huyền môn hướng đông." },
          { chuong: 99, importance: "major", tieuDe: "Vĩnh viễn rời Quyển 1", text: "Dùng linh thức quan sát từ xa cảnh đám cưới em gái trong thôn — cha mẹ đầu bạc lưng còng, tam thúc, Hàn Thiết. Quyết định vĩnh viễn không trở lại, tiếp tục con đường tu tiên độc lập. Khép lại toàn bộ mối liên hệ với thế giới phàm nhân, đặt dấu chấm hết cho Quyển 1." },
          { chuong: 103, importance: "minor", text: "Tới Gia Nguyên Thành — cố hương Mặc đại phu. Bị đám đầu mục bến đò phục kích; dùng thân pháp giết Hắc Hùng, ép Tôn nhị cẩu nuốt độc khống chế làm thủ hạ tai mắt." },
          { bridge: true, khoang: "c0104–c0106", text: "Đọc di thư Mặc đại phu: xác nhận âm hàn chi độc ngưng kết trong đan điền còn hai tháng trước khi bộc phát; qua Tôn nhị cẩu nắm bố cục ba đại bang và âm mưu Ngô Kiếm Minh. Tại tửu lâu dùng Thiên Nhãn Thuật nhận ra tu tiên giả pháp lực thâm hậu; nghe lén biết Thăng Tiên hội và tên gọi Trúc Cơ đan — lần đầu hiểu sơ cảnh giới tiếp theo." },
          { bridge: true, khoang: "c0107–c0112", text: "Lén nhập Mặc phủ, vượt bẫy ám tiễn; ra mặt với Nghiêm thị bằng nhẫn tín vật; kháng lại mê hồn thuật Tam nương; gặp đủ bốn phu nhân và chứng kiến các bà giải mã ám thư." },
          { chuong: 116, importance: "normal", tieuDe: "Lập uy trước các phu nhân Mặc phủ", text: "Phô Hỏa Đạn Thuật (hỏa cầu biến bàn thành tro) trước mặt các phu nhân để lập uy; phá mê dược thiên nhân túy trong nến trắng nhờ phương pháp đề phòng từ thời Thất Huyền môn." },
          { chuong: 117, importance: "normal", tieuDe: "Đàm phán Noãn Dương Bảo Ngọc — bị từ chối", text: "Đàm phán với Nghiêm thị: kể toàn bộ chân tướng cái chết Mặc đại phu và âm mưu Dư Tử Đồng; yêu cầu Noãn Dương Bảo Ngọc — bị từ chối vì Mặc phủ đang nguy cơ diệt môn." },
          { bridge: true, khoang: "c0118–c0121", text: "Đề nghị nhị tuyển nhất với Nghiêm thị; dùng Tiêu Hồn Tán diệt Trầm Trọng Sơn và cả nhóm Tứ bình bang cũ; cài Tôn nhị cẩu làm bang chủ bù nhìn." },
          { chuong: 123, importance: "minor", text: "Từ chối lấy bất kỳ tiểu thư Mặc phủ; đặt điều kiện chỉ giết Âu Dương Phi Thiên đổi lấy Noãn Dương Bảo Ngọc; buộc phu nhân nuốt thuốc làm con tin." },
          { chuong: 126, importance: "normal", tieuDe: "Giải hàn độc — gặp Thái Nam hội", text: "Dùng Noãn Dương Bảo Ngọc áp đan điền hơn 15 ngày, trị lành hoàn toàn hàn độc. Ám sát Âu Dương Phi Thiên bằng kiếm phù khi hắn một mình ngắm trăng. Tại Thái Nam sơn, gặp Vạn Tiểu Sơn — xác nhận là tu tiên giả, nhận ra đây là địa điểm Thái Nam hội." },
          { bridge: true, khoang: "c0127–c0128", text: "Moi từ Vạn Tiểu Sơn kiến thức tu tiên giới: hệ thống cảnh giới ba giai đoạn, thọ mệnh theo cấp, bốn loại linh căn, bảy môn phái Việt quốc. Lần đầu bước vào Thái Nam tiểu hội — sự kiện giao dịch năm năm một lần; đề phòng cao độ trước mọi người trong hội." },
          { bridge: true, khoang: "c0129–c0132", text: "Bị Thanh Nhan chân nhân nghi ngờ tâm thuật bất chánh; từ chối nhóm Tùng Văn đạo sĩ; đổi Hoàng Long Đan lấy Phi hành phù, Không bạch phù chỉ và quyển chú thư; gặp nhóm tán tu gồm Ngô Cửu Chỉ và Hoàng Hiếu Thiên." },
          { chuong: 136, importance: "minor", text: "Hỏi Khổ Tang về cách chế linh phù; nhận ra huynh muội Yến gia (đệ nhất gia tộc có Kết Đan kỳ) đến dự; muốn mua Trường Xuân công tầng cao." },
          { chuong: 137, importance: "normal", tieuDe: "Đổi được Trường Xuân công cao tầng", text: "Đổi đan dược lấy quyển Trường Xuân công tầng 1-13 và Kim Trúc bút (dị bảo chế phù) — di vật tộc một thiếu nữ đổi để anh trai tham gia lôi đài." },
          { bridge: true, khoang: "c0138–c0140", text: "Thử chế phù thất bại nhiều lần; Trường Xuân công đột phá tầng 9 trước khi hội kết thúc; chứng kiến hán tử da đen rao Tàn Phiến — pháp bảo ẩn hình qua mặt cả Thiên Nhãn Thuật; dùng Phi hành phù đổi lấy Tàn Phiến." },
          { chuong: 141, importance: "normal", tieuDe: "Vỡ lẽ Thăng Tiên Lệnh của Hoàng Phong Cốc", text: "Đọc 'Thanh Khê bút lục', vỡ lẽ Thăng Tiên Lệnh do Hoàng Phong Cốc phát — lệnh bài đen thu từ Chu Nho chính là tư cách nhận Trúc Cơ đan + nhập môn." },
          { chuong: 142, importance: "normal", tieuDe: "Bị Tùng Văn phục kích — thoát hiểm", text: "Bị Tùng Văn đạo sĩ lén rắc phấn định vị, bị hai kẻ mai phục tại ao bùn — băng trùy xuyên vai và chân trái; tự phong mạch cầm máu, dùng súc cốt công thoát ra." },
          { bridge: true, khoang: "c0143–c0146", text: "Phản sát hai kẻ tập sát (thuật biến cát + pháp lực xuyên tim), thu hơn 50 linh thạch và pháp khí; sau đó tới Hoàng Phong Cốc trình Thăng Tiên Lệnh xin nhập môn." },
          { chuong: 147, importance: "major", tieuDe: "Chính thức nhập môn Hoàng Phong Cốc", text: "Nộp Thăng Tiên Lệnh tại Hoàng Phong Cốc; bị xác định tứ thuộc tính ngụy linh căn, xác suất Trúc Cơ ~1%. Nhường Trúc Cơ đan cho cháu Diệp Tính đổi lấy quyền tùy ý chọn công tác trồng linh dược. Chưởng môn chấp thuận; Hàn Lập chính thức là Chấp sự đệ tử Hoàng Phong Cốc — đổi hoàn toàn tông môn, bước vào giới tu tiên thật." },
          { bridge: true, khoang: "c0148–c0151", text: "Nhận vật phẩm đệ tử mới (Hoàng ti sam, Thanh Diệp pháp khí, Liệt Dương kiếm, túi trữ vật); chọn nhiệm vụ Bách Dược Viên tại Kim Phù lĩnh dù người trước đều thất bại; bí mật chôn bình thần bí ở góc dược viên, phủ Tàn Phiến che dấu hiệu thu linh khí." },
          { chuong: 152, importance: "normal", tieuDe: "Hai năm tiềm tu — đạt tầng 11", text: "Hơn hai năm tiềm tu tại Bách Dược Viên: Trường Xuân công liên tiếp đột phá hai tầng lên tầng 11 — trung đẳng trong đệ tử cấp thấp. Hoàng Long Đan và Kim Tủy Hoàn hết hẳn công hiệu; bắt đầu tìm đan dược mới." },
          { bridge: true, khoang: "c0153–c0156", text: "Lần đầu vào Nhạc Lộc điện qua Truyền tống trận; gặp Hứa lão gian thương; tìm được đan phương Trúc Cơ đan nhưng cần tiên thiên chân hỏa (chỉ Trúc Cơ kỳ mới có); biết địa phế chi hỏa thay thế; mua Ngân Ti đỉnh (đan lô) giá 32 linh thạch." },
          { chuong: 160, importance: "major", tieuDe: "Biết Huyết Cấm Thí Luyện — tiến thoái lưỡng nan", text: "Ngô Phong tiết lộ chủ dược Trúc Cơ đan chỉ còn trong cấm địa phía sau Hoàng Phong Cốc — bị cổ cấm phong bế, chỉ Luyện Khí kỳ vào được, tỉ lệ sống sót dưới một phần tư. Sự kiện gọi là Huyết Cấm Thí Luyện, nửa năm nữa sẽ diễn ra. Hàn Lập mấy ngày liên tục cân nhắc: không tham gia thì Trúc Cơ vô vọng; tham gia thì 3/4 cơ hội chết. Đây là nút thắt quyết định toàn bộ hướng đi tiếp theo." },
          { chuong: 161, importance: "normal", tieuDe: "Quyết định vào cấm địa — nhận Liễm khí thuật", text: "Quyết định tham gia Huyết Cấm Thí Luyện. Ngô Phong truyền Liễm khí thuật — thu giấu pháp lực trông như người phàm — để tránh bị cao thủ tiêu diệt trước trong cấm địa." },
          { bridge: true, khoang: "c0162–c0165", text: "Ra phường thị Hoàng Phong Cốc mua vật phẩm; tại Vạn Bảo Lâu dùng 2 gốc linh thảo ngàn năm đổi toàn bộ hộp gấm: Kim phù tử mẫu đao, Huyền thiết phi thiên thuẫn, Thiên lôi tử, Kim Quang Chuyên phù bảo, Hoàng tinh chi." },
          { chuong: 165, importance: "minor", text: "Rời Vạn Bảo Lâu, tình cờ phát hiện Lục sư huynh cưỡng bức Trần sư muội bằng Hợp Hoan Hoàn; trong túi Trần sư muội lộ hộp gỗ đỏ chứa 2 viên Trúc Cơ đan thật — mục tiêu hắn đang cần." },
          { bridge: true, khoang: "c0166–c0168", text: "Ác đấu Lục sư huynh (Luyện Khí tầng 12, phong linh căn): xây ba lớp phòng thủ Tinh cương hoàn + Huyền thiết thuẫn + Kim Cương phù; kích hoạt Kim Quang Chuyên phù bảo hóa cự kiếm chặn Thanh giao khổng lồ." },
          { chuong: 169, importance: "major", tieuDe: "Hạ Lục sư huynh — đoạt Trúc Cơ đan", text: "Tiêu hao pháp lực kéo dài: Hàn Lập bí mật nhai linh thảo duy trì ưu thế, chủ động bỏ lớp bảo hộ dồn lực điều cự kiếm chém đỉnh đầu Lục sư huynh đồng thời thi triển La Yên bộ tới cực hạn né đao phong. Lục sư huynh bị chém làm đôi. Thu Thanh Giao Kỳ và bình xanh chứa 2 viên Trúc Cơ đan thật từ túi trữ vật địch. Kim Quang Chuyên phù bảo hóa tro sau trận — hết tuổi thọ." },
          { bridge: true, khoang: "c0170–c0171", text: "Khống chế Trần sư muội bằng Định Thần Phù rồi đưa về an toàn. Phi tang thi thể Lục sư huynh bằng Hỏa Đạn Thuật; bế quan 3 ngày khu trừ dị vật trong đan điền." },
          { chuong: 172, importance: "normal", tieuDe: "Quyết tham gia Huyết Cấm Thí Luyện ngay lần này", text: "Biết cấm địa sẽ bị phong bế 60 năm sau lần mở năm nay — nếu chờ thì đã quá tuổi Trúc Cơ tốt nhất. Dù đã có 2 viên Trúc Cơ đan nhưng với ngụy linh căn vẫn cần chủ dược trong cấm địa. Quyết tham gia ngay lần này. Bịa chuyện 'Long Lân quả' giải thích tu vi tăng đột biến cho Vương sư thúc." },
          { bridge: true, khoang: "c0173–c0175", text: "Tập hợp tại Nghị sự đại điện; gặp lại Trần sư muội — lãnh diễm, không nhận ra hắn. Gặp lần đầu Lý Sư Tổ (Kết Đan kỳ bí ẩn của Hoàng Phong Cốc) — ngũ tạng như bị nhìn xuyên; từ chối ý định bái sư vì bí mật quá nhiều. Cưỡi Ngân Giáp Giác Mãng tới điểm hẹn tại Kiến Châu; từ chối Hướng Tính đề nghị liên minh." },
          { bridge: true, khoang: "c0176–c0178", text: "Trên đường tới điểm tập kết, quan sát các đoàn dự Huyết Cấm — đặc biệt đoàn Yểm Nguyệt tông toàn đệ tử trẻ song tu không một lão giả, nghi có âm mưu riêng." },
          { chuong: 179, importance: "normal", tieuDe: "Phá Phong Nhận đại trận — vào cấm địa", text: "Bảy tổ sư Kết Đan kỳ cùng pháp bảo bản mệnh công phá Phong Nhận đại trận mấy canh giờ mới mở thông đạo. Vào thông đạo — ngay khi ra đầu kia bị na di trận pháp bên trong truyền tống đến góc ngẫu nhiên trong cấm địa, toàn đoàn tan tác." },
          { chuong: 180, importance: "normal", tieuDe: "Khởi bộ trong cấm địa — hiểu quy tắc sinh tử", text: "Tỉnh dậy tại vùng đất xám bùn lầy cây cối quái dị, định vị được gần Ô Long đàm phía Đông Bắc. Thi triển Ẩn hình thuật, cảnh giác đi bộ tìm Hàn yên thảo. Chứng kiến hai đệ tử Linh Thú Sơn lập mưu dụ-giết đệ tử Thiên Khuyết bảo — bước đầu hiểu rõ quy tắc sinh tử trong cấm địa." }
        ],
        tuViMoc: [
